// Icons - simple SVG icons inline (Lucide-style strokes)
const Icon = ({ name, size = 18, className = '', strokeWidth = 2 }) => {
  const paths = {
    home: <><path d="M3 12l9-9 9 9"/><path d="M5 10v10h14V10"/></>,
    clock: <><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></>,
    'alert-triangle': <><path d="M12 3L2 20h20L12 3z"/><path d="M12 10v5"/><circle cx="12" cy="18" r=".6" fill="currentColor"/></>,
    calendar: <><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 10h18M8 3v4M16 3v4"/></>,
    plane: <><path d="M17.8 19.2L16 11l3.5-3.5A2.12 2.12 0 0 0 16.5 4.5L13 8 4.8 6.2a.5.5 0 0 0-.5.8L9 12l-2 3H4l1.5 2L7 18.5 9 17l5-1 4.2 4a.5.5 0 0 0 .8-.5z"/></>,
